...
const SalesCard = ({totalAmount, bgColor, titleColor, moneyColor, title, rupeesSymbol}) => {
  return (
    <div className={`m-2 ${bgColor}  w-64 mx-auto  justify-center items-center rounded-lg shadow-lg `}>
       <h4 className={`text-center ${titleColor}  font-bold text-md px-4 pt-4`}>{title}</h4>
